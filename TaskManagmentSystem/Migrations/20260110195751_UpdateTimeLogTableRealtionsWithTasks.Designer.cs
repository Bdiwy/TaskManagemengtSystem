...
namespace TaskManagmentSystem.Migrations
{
    ...
    [Migration("20260110195751_UpdateTimeLogTableRealtionsWithTasks")]
    partial class UpdateTimeLogTableRealtionsWithTasks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagmentSystem.Models.TimeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Actul")
                        .HasColumnType("int");

                    b.Property<int>("Allocat")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagmentSystem.Models.TimeLog", b =>
                {
                    b.HasOne("TaskManagmentSystem.Models.UserTask", "Task")
                        .WithMany()
